...
export const products: Product[] = [
  ...
  originalPrice: 6999,
  description:
    "Elegant royal silk sharara suit featuring intricate zari embroidery and a matching dupatta.",
  image: "/images/products/royal-silk-sharara-suit.jpg",
  images: [
    "/images/products/royal-silk-sharara-suit.jpg",
  ],
  badge: "New Arrival",
  newArrival: true,
  color: "Royal Blue",
